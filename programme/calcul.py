    ...
    with open(name, "r") as myfile:
        ...
        if(dayweek in data):
            ...
            if not os.path.isfile(lanceur):
                ...
                data[int(dayweek)] = str(dayweek)+"---"+str(start_to_write_h)+"---"+str(start_to_write_m)+"---"+str(end_h)+"---"+str(end_m)+"---"+str(pause)+"---0---0---0---0\n"
            else:
                star_pause_h = int(line_splited[6])
                star_pause_m = int(line_splited[7])
                end_pause_h = int(line_splited[8])
                ...
                data[int(dayweek)] = str(dayweek)+"---"+str(start_to_write_h)+"---"+str(start_to_write_m)+"---"+str(end_h)+"---"+str(end_m)+"---"+str(pause)+"---"+str(star_pause_h)+"---"+str(star_pause_m)+"---"+str(end_pause_h)+"---"+str(end_pause_m)+"\n"
                
            
        else:
            start_to_write_h = start_h
            start_to_write_m = start_m
            data[int(dayweek)] = str(dayweek)+"---"+str(start_to_write_h)+"---"+str(start_to_write_m)+"---"+str(end_h)+"---"+str(end_m)+"---0---0---0---0---0\n"
